                  ...
                  {Object.entries(job.with).map(([key, value]) => (
                    <div key={key} className="flex items-center gap-1">
                      <input
                        ...
                        className="w-1/3 flex-shrink-0 rounded border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-200 px-1.5 py-0.5 text-xs"
                      ...
                      <input
                        ...
                        className="flex-1 font-mono rounded border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-200 px-1.5 py-0.5 text-xs"
                        placeholder="Value"
                      />
                      <button
                        type="button"
